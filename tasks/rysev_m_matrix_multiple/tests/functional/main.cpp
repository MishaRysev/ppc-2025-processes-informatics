...
std::vector<int> SequentialMultiply(const std::vector<int>& A, const std::vector<int>& B, 
                                     int m, int k, int n) {
...
INSTANTIATE_TEST_SUITE_P(MatrixMultiplicationTests, RysevMRunFuncTestsProcesses, 
