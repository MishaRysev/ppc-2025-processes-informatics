...
const auto kSmallTask = ppc::util::MakePerfTask<InType, RysevMMatrMulMPI, RysevMMatrMulSEQ>(
    "small", PPC_SETTINGS_example_processes);

const auto kMediumTask = ppc::util::MakePerfTask<InType, RysevMMatrMulMPI, RysevMMatrMulSEQ>(
    "medium", PPC_SETTINGS_example_processes);

const auto kLargeTask = ppc::util::MakePerfTask<InType, RysevMMatrMulMPI, RysevMMatrMulSEQ>(
    "large", PPC_SETTINGS_example_processes);
...
INSTANTIATE_TEST_SUITE_P(MatrixMultiplicationPerfTests, RysevMPerfTestProcesses, 
